...
REQUIRED_FILES = [
    ...
    "configs/saes/dino_l7_topk32_exp4.yaml",
    "configs/saes/dino_l9_topk32_exp4.yaml",
    "configs/saes/dino_l10_topk32_exp4.yaml",
    "configs/saes/dino_l11_topk32_exp4.yaml",
    "configs/saes/ijepa_l8_topk32_exp4.yaml",
    "configs/saes/ijepa_l20_topk32_exp4.yaml",
    "configs/saes/ijepa_l30_topk32_exp4.yaml",
    "configs/saes/ijepa_l31_topk32_exp4.yaml",
    "configs/sweeps/ranking_control.yaml",
    "configs/sweeps/layer_sweep.yaml",
